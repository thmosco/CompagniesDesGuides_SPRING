...
<p>Vous pouvez choisir des sommets et des abris. Lorsque vous avez faits votre choix utiliser le boutton en bas de page "Passer à l'étape suivante" pour configurer votre randonnée.</p>
		...
		for (SommetsModel s:sommets){
			...
			<div class="card bg-dark text-white">
	  				...
	  				<div class="card-body">
	  					...
	  					<p class="card-text">Vous pouvez accéder à ce sommet par les abris : 
	  					<%
	...
	<% 
					...
					for (AbrisModel a:abris) {
						...
						<div class="card bg-light" style="min-height: 266px">
						  ...
						  <input type="submit" class="btn btn-primary btn-lg btn-block mb-2" value="Passer à l'étape suivante !">
				</form>
	</div>
